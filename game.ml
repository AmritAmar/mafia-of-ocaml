...
let init_state lst =
    ...
    {day_count = 0; stage = Discussion;
        ...
        (Time.now (),
            ...
            "found and executed! These are your fellow members of the mafia: "^
            (get_mafia pl "")))]}
...
let disc_to_voting st updates =
    {st with stage = Voting;
             announcement_history = (Time.now (), (All,
                ...
                "Please vote on a player that you think "^
...
let time_span state =
    ...
    | Night -> Core.Time.Span.of_sec 45.
