...
(**
 * [get_recent_announcements ()] will return the most recent
 * announcements, sorted from most recent to least recent.
 *)
val get_recent_announcements : client_state -> string list

(**
 * [get_recent_msgs ()] will return the most recent messages, sorted
